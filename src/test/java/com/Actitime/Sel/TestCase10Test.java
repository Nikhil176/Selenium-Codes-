...
public void execTest1() throws Exception
{
	...
	driver.findElement(By.xpath("//*[@id='tasksListForm']/table/tbody/tr[2]/td/table/tbody/tr[3]/td[7]/input")).click();
	try {
		Thread.sleep(5000);
	} catch (InterruptedException ex) {
		// TODO Auto-generated catch block
	...
	driver.findElement(By.xpath("//*[@id='tasksListForm']/table/tbody/tr[3]/td/table/tbody/tr/td/div/table/tbody/tr/td[1]/input")).click();
	try {
		Thread.sleep(5000);
	} catch (InterruptedException ex) {
		// TODO Auto-generated catch block
	...
	CustomAssert.verifyEqual(Result,"Selected tasks have been successfully deleted.");
