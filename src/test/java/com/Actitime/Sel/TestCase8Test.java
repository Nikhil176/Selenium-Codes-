...
public void execTest1() throws Exception
{
	...
	driver.findElement(By.xpath("//*[@id='customersProjectsForm']/table/tbody/tr/td/table/tbody/tr[5]/td/table/tbody/tr[3]/td[2]/a")).click();
	try {
		Thread.sleep(5000);
	} catch (InterruptedException ex) {
		// TODO Auto-generated catch block
	...
	driver.findElement(By.xpath("//*[@id='createTasksPopup_createTasksTableContainer']/table/tbody/tr[1]/td[1]/input")).sendKeys("Actitime task");
	try {
		Thread.sleep(5000);
	} catch (InterruptedException ex) {
		// TODO Auto-generated catch block
	...
	CustomAssert.verifyEqual(Result,"1 new task was added to the customer \"Abhishek B\", project \"Acti Time Project\".");
