...
public void execTest1() throws Exception
{
	...
	driver.findElement(By.xpath("//*[@id='customersProjectsForm']/table/tbody/tr/td/table/tbody/tr[5]/td/table/tbody/tr[2]/td/table/tbody/tr/td/a")).click();
	try {
		Thread.sleep(5000);
	} catch (InterruptedException ex) {
		// TODO Auto-generated catch block
	...
	driver.findElement(By.xpath("//*[@id='customerLightBox_nameField']")).sendKeys("Abhishek Bhattacharjee");
	try {
		Thread.sleep(5000);
	} catch (InterruptedException ex) {
		// TODO Auto-generated catch block
	...
	driver.findElement(By.xpath("//*[@id='customerLightBox_descriptionField']")).sendKeys("Abhishek Bhattacharjee");
	try {
		Thread.sleep(5000);
	} catch (InterruptedException ex) {
		// TODO Auto-generated catch block
